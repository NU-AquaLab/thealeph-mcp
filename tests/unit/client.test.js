#!/usr/bin/env node
/**
 * Unit tests for The Aleph API Client
 */
...
class ClientTests {
  ...
  async runTests() {
    console.log('🧪 Running The Aleph API Client Unit Tests\n');
  ...
  async testClientInitialization() {
    ...
    try {
      ...
      this.assert(client1.baseUrl === 'https://thealeph.ai', 'Default URL should be production server');
